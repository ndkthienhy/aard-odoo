...
class ProjectTask(models.Model):
    ...
    def _get_project_followers(self, project):
        ...
        if user.has_group('project.group_project_manager') or (current_user_id in user_follow and (user.has_group('aard_project_permission.group_project_owner_manager') and project.user_id.id == current_user_id)):
            return user_follow
